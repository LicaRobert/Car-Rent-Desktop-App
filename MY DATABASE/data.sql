...
insert into CarRent ( ClientID, CarModel, StartDate, EndDate, City) values ('1', 'RX-7', '04/04/2007', '05/05/2007', 'Izmir');
insert into CarRent ( ClientID, CarModel, StartDate, EndDate, City) values ('8', 'Cayenne', '04/04/2007', '05/05/2007', 'Brasov');
insert into CarRent ( ClientID, CarModel, StartDate, EndDate, City) values ('3', 'RX-7', '02/02/2004', '05/03/2004', 'Rio de Janeiro');
insert into CarRent ( ClientID, CarModel, StartDate, EndDate, City) values ('4', '350Z', '01/01/2008', '02/02/2008', 'Porto Alegre');
insert into CarRent ( ClientID, CarModel, StartDate, EndDate, City) values ('5', '350Z', '04/04/2005', '05/05/2005', 'Suceava');
insert into CarRent ( ClientID, CarModel, StartDate, EndDate, City) values ('1', 'S-Class', '05/05/2007', '06/06/2007', 'Izmir');
insert into CarRent ( ClientID, CarModel, StartDate, EndDate, City) values ('6', 'G-Class', '12/11/2010', '12/12/2010', 'Brasov');
insert into CarRent ( ClientID, CarModel, StartDate, EndDate, City) values ('6', 'X5', '01/02/2011', '02/02/2011', 'Brasov');
insert into CarRent ( ClientID, CarModel, StartDate, EndDate, City) values ('5', 'X5', '03/03/2002', '05/05/2002', 'Bucharest');
insert into CarRent ( ClientID, CarModel, StartDate, EndDate, City) values ('6', 'RX-7', '10/10/2010', '12/11/2010', 'Brasov');
